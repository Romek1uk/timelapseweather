...
public class CsvWriter {
	...
	public void addEntry(CsvData data) throws IOException {
		...
		for (int i = 0; i < 256; i++) {
			if (data.getBrightnessHistogram() == null) {
	...
	public static void main(String[] args) throws IOException {
		...
		Image image = null;
		String imageFile = "D:\\Dropbox\\Dropbox\\Part II\\project\\doc\\dissertation\\images\\imp-sun.png";
		...
		CsvWriter writer = new CsvWriter("D:\\sun.csv");
