...
public class Evaluator {
	...
	private static final String _prefix = "D:\\Dropbox\\Dropbox\\Part II\\project\\data\\";

	public static void main(String args[]) {
//		for (int k = 10; k <= 100; k += 10) {
//			System.out.println("------ RANDOM FOREST " + k);
//
//			String filename = _prefix + "randomforests" + k + "\\" + "datamerged.csv" ;// "data/split/test0.csv";
//
//			for (int i = 4; i < 11; i++) {
//				try {
...
//
//		 filename = _prefix + "randomforests200\\" + "datamerged.csv" ;// "data/split/test0.csv";
//
//		for (int i = 4; i < 11; i++) {
//			try {
//				System.out.println(TITLES[i - 4] + ": " + TYPES[i - 4]);
...
//
//		 filename = _prefix + "j48\\" + "datamerged.csv" ;// "data/split/test0.csv";
//
//		for (int i = 4; i < 11; i++) {
//			try {
//				System.out.println(TITLES[i - 4] + ": " + TYPES[i - 4]);
...
//		
		...
		filename = _prefix + "smo\\" + "datamerged.csv" ;// "data/split/test0.csv";
